...
export const ServiceProviderQueAns = (props) => {
    ...
    return (
        <ServiceProviderContextQueAnsData.Provider value={[serviceProviderQueAnsData, setServiceProviderQueAnsData]}>
            {props.children}
...
export const ShoppingCartProvider = (props) => {
    ...
    return (
        <ShoppingCartContext.Provider value={[shoppingCartData, setShoppingCartData]}>
            {props.children}
...
export const OrderCategorySelectProvider = (props) => {
    ...
    return (
        <OrderCategorySelect.Provider value={[acctiveSelectedCatgory, setAcctiveSelectedCatgory]}>
            {props.children}
