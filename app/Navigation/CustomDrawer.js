            ...
            <View style={styles.ContainerView}>
                <View style={styles.NameContainer}>
                    {profileData.login_type == 2 ?
                        <Image style={styles.UserImge} source={{
                            uri:
                                logoBaseImgUrl + profileData.logo
                        }} />
                        :
                        <Image style={styles.UserImge} source={{
                            uri:
                    ...
                    <View style={styles.UserNameView}>
                        {profileData.login_type == 2 ?
                            <Text numberOfLines={1} style={[styles.UserNameText, { width: 120 }]}>
                        ...
                        <Text style={[styles.UserAddress, { width: 140 }]}>{profileData.hometown}</Text>
                    </View>
                </View>
                ...
                <DrawerContentScrollView {...props}>
                    ...
                    >
                        <View style={styles.ImgeView}>
                            <Image style={{ width: 20, height: 20 }} source={require('../Assets/dashboardicon.png')} />
                        </View>
                    ...
                    <TouchableOpacity
                        style={styles.contactUsContainer}
                        onPress={() => { props.navigation.navigate('FollowerList') }}
                    >
                        <View style={styles.ImgeView}>
        ...
        <View style={{ flex: 1 }}>
            <View style={{ height: '100%' }}>
                ...
                <DrawerContentScrollView {...props}>
                    ...
                    >
                        <View style={styles.ImgeView}>
                            <Image style={{ width: 25, height: 25 }} source={require('../Assets/drawerhome.png')} />
                        </View>
                        <View style={styles.TextContain}>
                    ...
                    >
                        <View style={styles.ImgeView}>
                            <Image style={{ width: 25, height: 25 }} source={require('../Assets/businessprofile.png')} />
                        </View>
                        <View style={styles.TextContain}>
                    ...
                    <TouchableOpacity
                        style={styles.contactUsContainer}
                        onPress={() => { props.navigation.navigate('BussinessInfo') }}
                    >
                        <View style={styles.ImgeView}>
                            <Image style={{ width: 25, height: 25 }} source={require('../Assets/businessinformation.png')} />
                        </View>
                        <View style={styles.TextContain}>
                    ...
                    <TouchableOpacity
                        style={styles.contactUsContainer}
                        onPress={() => { props.navigation.navigate('OpeningHours') }}
                    >
                        <View style={styles.ImgeView}>
                            <Image style={{ width: 25, height: 25 }} source={require('../Assets/openinghours.png')} />
                        </View>
                        <View style={styles.TextContain}>
                    ...
                    <TouchableOpacity
                        style={styles.contactUsContainer}
                        onPress={() => { props.navigation.navigate('JobManagementList') }}
                    >
                        <View style={styles.ImgeView}>
                            <Image style={{ width: 25, height: 25 }} source={require('../Assets/teamwork.png')} />
                        </View>
                        <View style={styles.TextContain}>
                    ...
                    <TouchableOpacity
                        style={styles.contactUsContainer}
                        onPress={() => { props.navigation.navigate('RestaurantManagement') }}
                    >
                        <View style={styles.ImgeView}>
                            <Image style={{ width: 25, height: 25 }} source={require('../Assets/diet.png')} />
                        </View>
                        <View style={styles.TextContain}>
                    ...
                    <TouchableOpacity
                        style={styles.contactUsContainer}
                        onPress={() => { props.navigation.navigate('BusinessOrderHistory') }}
                    >
                        <View style={styles.ImgeView}>
                            <Image style={{ width: 25, height: 25 }} source={require('../Assets/box.png')} />
                        </View>
                        <View style={styles.TextContain}>
                    ...
                    <TouchableOpacity
                        style={styles.contactUsContainer}
                        onPress={() => { props.navigation.navigate('MyProductList') }}
                    >
                        <View style={styles.ImgeView}>
                            <Image style={{ width: 25, height: 25 }} source={require('../Assets/diet.png')} />
                        </View>
                    ...
                    <TouchableOpacity
                        style={styles.contactUsContainer}
                        onPress={() => { props.navigation.navigate('BusinessChangePassword') }}
                    >
                        <View style={styles.ImgeView}>
                            <Image style={{ width: 25, height: 25 }} source={require('../Assets/diet.png')} />
                        </View>
