...
import { Image, StatusBar, View, StyleSheet, ActivityIndicator } from 'react-native';
...
function CustomBusinessNavigation() {
    return (
        <BusinessDrawer.Navigator
            ...
            <BusinessDrawer.Screen name="BusinessHome" component={BusinessHomeScreen} />
            <BusinessDrawer.Screen name="BusinessProfile" component={BusinessProfileScreen} />
            <BusinessDrawer.Screen name="BussinessInfo" component={BussinessInfoScreen} />
            <BusinessDrawer.Screen name="OpeningHours" component={OpeningHoursScreen} />
            <BusinessDrawer.Screen name="JobManagementList" component={JobManagementListScreen} />
            <BusinessDrawer.Screen name="RestaurantManagement" component={RestaurantManagementScreen} />
            <BusinessDrawer.Screen name="BusinessOrderHistory" component={BusinessOrderHistoryScreen} />
            <BusinessDrawer.Screen name="MyProductList" component={MyProductListScreen} />
        </BusinessDrawer.Navigator>
    )
};
...
function CustomDrawerNavigation() {
    return (
        <customDrawer.Navigator
            ...
            <customDrawer.Screen name="ProfileSettings" component={ProfileSettingsScreen} />
            <customDrawer.Screen name="FollowingList" component={FollowingListScreen} />
            ...
            <customDrawer.Screen name="Notifications" component={NotificationsScreen} />
            <customDrawer.Screen name="RecentActivity" component={RecentActivityScreen} />
...
function AuthStack() {
    return (
        <Auth.Navigator screenOptions={{ headerShown: false }} >
            ...
            <Auth.Screen name="BusinessUserVerify" component={BusinessUserVerifyScreen} />
            <Auth.Screen name="ForgotPassword" component={ForgotPasswordScreen} />
            <Auth.Screen name="ForgotPasswordField" component={ForgotPasswordFieldScreen} />
            {/* { business} */}
            ...
            <Business.Screen name="BusinessLocation" component={BusinessLocationScreen} />
...
function BusinessStack() {
    return (
        <Business.Navigator screenOptions={{ headerShown: false }} >
            ...
            <Business.Screen name="BusinessProductDetails" component={BusinessProductDetailsScreen} />
            ...
            <Business.Screen name="BasicInformation" component={BasicInformationScreen} />
            <Business.Screen name="BusinessOrderHistory" component={BusinessOrderHistoryScreen} />
            <Business.Screen name="BusinessProfile" component={BusinessProfileScreen} />
            <Business.Screen name="BussinessInfo" component={BussinessInfoScreen} />
            <Business.Screen name="Confirm" component={ConfirmScreen} />
            <Business.Screen name="JobManagementList" component={JobManagementListScreen} />
            ...
            <Business.Screen name="TableManagement" component={TableManagementScreen} />
            <Business.Screen name="AddTable" component={AddTableScreen} />
            <Business.Screen name="RestaurantManagement" component={RestaurantManagementScreen} />
            ...
            <Business.Screen name="BusinessLocation" component={BusinessLocationScreen} />
            <Business.Screen name="Budgets" component={BudgetsScreen} />
            <Business.Screen name="BusinessChangePassword" component={BusinessChangePasswordScreen} />

            <Business.Screen name="FoodOrderDetails" component={FoodOrderDetailsScreen} />
            <Business.Screen name="TableBookingDetails" component={TableBookingDetailsScreen} />
            <Business.Screen name="ServiceOrderDetails" component={ServiceOrderDetailsScreen} />
            <Business.Screen name="OutSideBookingOrderDetails" component={OutSideBookingOrderDetailsScreen} />
            <Business.Screen name="ShoppingOrderDetails" component={ShoppingOrderDetailsScreen} />


            <Business.Screen name="AddEditBusinessCategory" component={AddEditBusinessCategoryScreen} />
        </Business.Navigator>
    )
};
function AppStack() {
    return (
        <Stack.Navigator screenOptions={{ headerShown: false }} >
            ...
            <Stack.Screen name="OrderDetailBackEnd" component={OrderDetailScreenBackEnd} />
            ...
            <Stack.Screen name="ManageFriendInvite" component={ManageFriendInviteScreen} />
            ...
            <Stack.Screen name="StepFourth" component={StepFourthScreen} />{/* not in use */}
            <Stack.Screen name="StepSix" component={StepSixScreen} />{/* not in use */}
            ...
            <Stack.Screen name="ServiceProviderListing" component={ServiceProviderListingScreen} />
            <Stack.Screen name="RestauranrtBooking" component={RestauranrtBookingScreen} />
