...
import { LINE_COMMON_COLOR_CODE, FONT_FAMILY_REGULAR, BLACK_COLOR_CODE } from '../../../Utils/Constant';
                ...
                <ScrollView>
                    <SafeAreaView style={{ alignItems: 'center' }}>
                        ...
                        <View style={styles.paginationWrapper}>
                            {Array.from(Array(props.restroDetail && props.restroDetail.image && props.restroDetail.image.length).keys()).map((key, index) => (
                    ...
                    <View style={styles.RestroDetailView}>
                        ...
                        <View style={styles.FlexRowView}>
                            ...
                            <Text style={styles.RateTextStyle}>{props.restroDetail.business_service_category}</Text>
                        </View>
                        <View style={styles.RatingContainer}>
                            <View style={styles.RatingStyles}><Text style={styles.RatingStylesTxt}>5.0</Text></View>
                            <Text style={styles.RatingTextMain}> {props.restroDetail.rating}  ratings | </Text>
                            ...
                            <Text style={styles.RatingTextMain}>
                                {
                                    props.restroDetail && props.restroDetail.business_open_time && props.restroDetail.business_open_time.open_time +
                                    ' - '}
                                {props.restroDetail && props.restroDetail.business_open_time && props.restroDetail.business_open_time.close_time
                                }
                            </Text>
                        </View>
                    </View>
                    <View style={styles.AddShareContainer}>
                        <TouchableOpacity
                            ...
                            <Text style={styles.DateSTyles}>{props.date && props.date ? props.date : 'Date'}</Text>
                            <View style={[styles.TextInputImg, { marginRight: 25 }]}>
                                <Image style={[styles.TextInputImageStyle, { height: 24 }]} source={require('../../../Assets/info_calendar_icon.png')} />
                            </View>
                            <DateTimePickerModal
                        ...
                        <TouchableOpacity
                            ...
                            style={styles.CalenderSelect}>
                            <Text style={styles.DateSTyles}>{props.time && props.time ? props.time : 'Time'}</Text>
                            <View style={[styles.TextInputImg, { marginRight: 25 }]}>
                                <Image style={[styles.TextInputImageStyle, { height: 24 }]} resizeMode='contain' source={require('../../../Assets/clock_icon2.png')} />
                            </View>
                        </TouchableOpacity>
                        <DateTimePickerModal
                        ...
                        <View>
                            <Input
                                onChangeText={(SelectPeople) => props.setSelectPeople(SelectPeople)}
                            ...
                            <FlatList
                                ...
                                renderItem={({ item, index }) =>
                                    <TouchableOpacity
                                        ...
                                        <Text style={{ fontFamily: FONT_FAMILY_REGULAR, fontSize: 16 }}>{item.startTime}</Text>
                                    </TouchableOpacity>
                                }
                            />
                            {
                                ...
                                <TouchableOpacity
                                    ...
                                    <Image style={styles.ArrowImge} source={require('../../../Assets/link_dropdown_icon.png')} />
                                    <Text style={styles.SeereservatnTxt}>See reservations on other dates</Text>
                                </TouchableOpacity>
                            }
                            <FlatList
                                keyExtractor={(item, index) => index.toString()}
                                        ...
                                        <View>
                                            <TouchableOpacity
                                                ...
                                                <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
                                                    <Image style={styles.ArrowImge} tintColor={BLACK_COLOR_CODE} source={require('../../../Assets/link_dropdown_icon.png')} />
                                                </View>
                                            </TouchableOpacity>
                        ...
                        <View style={styles.LocationTxtView}>
                            ...
                            <View style={styles.AboutContainer}>
                                <View style={styles.flexDirectionStyle}>
                                    <Image style={styles.AboutImge} source={require('../../../Assets/about_icon_1.png')} />
                                    <Text style={styles.MainCovidPara}>Good for Groups</Text>
                                </View>
                                <View style={{ flexDirection: 'row', paddingLeft: 15 }}>
                                    <Image style={styles.AboutImge} source={require('../../../Assets/about_icon_2.png')} />
                                    <Text style={styles.MainCovidPara}>Greate Date Spot</Text>
                                </View>
                            </View>
                            <View style={styles.AboutContainer}>
                                <View style={styles.flexDirectionStyle}>
                                    <Image style={styles.AboutImge} source={require('../../../Assets/about_icon_3.png')} />
                                    <Text style={styles.MainCovidPara}>Casual Attire</Text>
                                </View>
                                <View style={{ flexDirection: 'row', paddingLeft: 15 }}>
                                    <Image style={styles.AboutImge} source={require('../../../Assets/about_icon_4.png')} />
                                    <Text style={styles.MainCovidPara}>Parking: Street, Private Lot</Text>
                                </View>
                            </View>
                            <Text style={[styles.MainCovidPara, { lineHeight: 21, paddingTop: 10 }]}>
                    ...
                    <View style={styles.AboutBusinessContain}>
                        ...
                        <FlatList
                            ...
                            renderItem={({ item, index }) => props._handlePeopleSaying(item, index)
                            }
                        />
                    </View>
                    <View style={styles.ReviewFullList}>
                        <Text style={[styles.CovidMainTxt]}>Recommended by Taichi Pot Shabu Shabu</Text>
                        <FlatList
                            keyExtractor={(item, index) => index.toString()}
                            data={props.restroDetail && props.restroDetail.recommended_business && props.restroDetail.recommended_business}
                            // data={props.handleReview}
                            horizontal={true}
                            renderItem={({ item, index }) => props._handleRecommended(item, index)
                            }
                        />
                    </View>
                </ScrollView>
