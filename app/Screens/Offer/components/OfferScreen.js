        ...
        <View style={{ flex: 5.4 }}>
          <View style={styles.hdngtextcon}>
            <Text
              style={[
                styles.text,
                { color: BLACK_COLOR_CODE, fontSize: 20, paddingBottom: 10 },
              ]}
            >
              AbbyPages user search for Home Services 1,001 times a month within
              25 miles of you
            </Text>
            ...
            <View style={{ flexDirection: "row", paddingLeft: 20 }}>
              ...
              <Text style={styles.text}>
                About 80% if AbbyPages users make a purchase at a business they
          ...
          <View style={{ flex: 1, paddingVertical: 10 }}>
            <View style={{ flexDirection: "row", paddingHorizontal: 20 }}>
              ...
              >
                <Text
                  style={[
                    styles.text,
                    { fontSize: 14, color: BLACK_COLOR_CODE },
                  ]}
                >
            ...
            <View style={{ flexDirection: "row", paddingHorizontal: 20 }}>
              ...
              <View
                style={{ flex: 5.5, justifyContent: "center", paddingLeft: 5 }}
              >
                <Text
                  style={[
                    styles.text,
