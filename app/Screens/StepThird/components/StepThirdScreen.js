            ...
            <ScrollView
                ...
                <View style={styles.inputtexvwe}>
                    ...
                    <View style={styles.inputwvwe}>
                        ...
                        />
                        <TouchableOpacity
                            onPress={() => props.setIsDatePickerVisible(true)}
                            style={{
                                backgroundColor: 'rgba(0,0,0,0)',
                                height: 70,
                                margin: 10,
                            ...
                            <Text style={{ fontFamily: FONT_FAMILY_REGULAR, fontSize: 16 }}>
                                {props.ZipCode && props.ZipCode.booking_date && props.ZipCode.booking_date ?
                        ...
                        <TouchableOpacity
                            ...
                            <Text style={{ fontFamily: FONT_FAMILY_REGULAR, fontSize: 16 }}>
                                {props.ZipCode && props.ZipCode.booking_time && props.ZipCode.booking_time ?
                        ...
                        <Input
                            onChangeText={(description) => props.setZipCode({
                                ...props.ZipCode,
