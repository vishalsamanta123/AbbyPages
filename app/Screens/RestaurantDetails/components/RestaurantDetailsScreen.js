...
const RestaurantDetailsScreen = (props) => {
    const initialRegion = {
        latitude: props.restroDetail.latitude ? parseInt(props.restroDetail.latitude) : 22.724480,
        longitude: props.restroDetail.longitude ? parseInt(props.restroDetail.longitude) : 75.889267,
        latitudeDelta: 0.015,
            ...
            <View style={[CommonStyles.body]}>
                <ScrollView>
                        ...
                        <Dialog
                            ...
                            <DialogContent>
                                <View style={styles.alertBackground}>
                                    <Text style={[styles.modalItem, { paddingBottom: 10 }]}>Please select</Text>
                    ...
                    <View style={styles.RestroDetailView}>
                        <Text style={styles.RestroNameTxt}>{props.restroDetail && props.restroDetail.business_name}</Text>
                        <View style={styles.FlexRowView}>
                            <Text style={styles.RateTextStyle}>
                                {props.restroDetail && props.restroDetail.business_star === 0 && '$ | '}
                                {props.restroDetail && props.restroDetail.business_star === 1 && '$  | '}
                                {props.restroDetail && props.restroDetail.business_star === 2 && '$$  | '}
                                {props.restroDetail && props.restroDetail.business_star === 3 && '$$$  | '}
                                {props.restroDetail && props.restroDetail.business_star === 4 && '$$$$  | '}
                                {props.restroDetail && props.restroDetail.business_star === 5 && '$$$$$  | '}
                            </Text>
                            {/* <FlatList
                                keyExtractor={(item, index) => index.toString()}
                            ...
                            /> */}
                            <Text style={styles.RateTextStyle}>{props.restroDetail && props.restroDetail.business_service_category}</Text>
                        </View>
                        <View style={styles.RatingContainer}>
                            <View style={styles.RatingStyles}><Text style={styles.RatingStylesTxt}>5.0</Text></View>
                            <Text style={styles.RatingTextMain}> {props.restroDetail && props.restroDetail.rating}  ratings | </Text>
                            <Text style={styles.MainClosedTime}>
                                {
                                    props.restroDetail && props.restroDetail.login_status === 1 ? 'Open' : 'Closed'
                                }
                             :</Text>
                    ...
                    <View style={styles.AddShareContainer}>
                        <View style={styles.AddShareView}>
                            <TouchableOpacity onPress={() => props.setAddPhotoModal(true)} style={styles.AddPhotoCOntainer}>
                                <Image source={require('../../../Assets/add_photo_icon.png')} />
                                <Text style={styles.AddOptnsTextMain}>Add Photo</Text>
                            </TouchableOpacity>
                            <View style={{ alignItems: 'center', flex: 2 }}>
                                <Image style={{ width: 19, height: 15 }} source={require('../../../Assets/share_icon.png')} />
                        ...
                        </View>
                        {
                            ...
                            <TouchableOpacity onPress={() => props.onPressReservation(props.restroDetail, 1)}
                        ...
                        }
                        {
                            ...
                            <TouchableOpacity onPress={() => props.onPressReservation(props.restroDetail, 2)} style={styles.CameraViewStyle}>
                                <Text style={styles.CameraMainText}>AYCE Outdoor now available!</Text>
                            </TouchableOpacity>
                        }
                    </View>
                    ...
                    <View style={styles.MainUpdateContainer}>
                        ...
                        <View style={styles.CovidParaView}>
                            ...
                            <View style={{ flexDirection: "row" }}>
                                <View style={styles.UpdateOptions}>
                                    {props.restroDetail && props.restroDetail.outdoor_seating === 1 ?
                                        <View style={{}}>
                                            <ImageBackground
                                ...
                                <View style={styles.UpdateOptions}>
                                    {props.restroDetail && props.restroDetail.offers_delivery === 1 ?
                                        <View style={{}}>
                                            <Image
                                                style={styles.RightImgeStyle}
                                                source={require('../../../Assets/text_check_icon.png')} />
                                ...
                                <View style={styles.UpdateOptions}>
                                    {props.restroDetail && props.restroDetail.offers_takeout === 1 ?
                                        <View style={{}}>
                                            <Image
                                                style={styles.RightImgeStyle}
                                                source={require('../../../Assets/text_check_icon.png')} />
                            ...
                            <View style={{ flexDirection: "row" }}>
                                <View style={styles.UpdateOptions}>
                                    {props.restroDetail && props.restroDetail.sitdown_dining === 1 ?
                                        <View style={{}}>
                                            <Image
                                                style={styles.RightImgeStyle}
                                                source={require('../../../Assets/text_check_icon.png')} />
                        ...
                        <View style={styles.CovidParaView}>
                            ...
                            <View style={{ flexDirection: "row" }}>
                                ...
                                <View style={styles.UpdateOptions}>
                                    {props.restroDetail && props.restroDetail.masks_required === 1 ?
                                        <View>
                                ...
                                <View style={styles.UpdateOptions}>
                                    {props.restroDetail && props.restroDetail.staff_wears_gloves === 1 ?
                                        <View>
                                            <Image style={styles.RightImgeStyle} source={require('../../../Assets/text_check_icon.png')} />
                                        </View>
                                        :
                    ...
                    <View style={styles.PopularDishContain}>
                        ...
                        <FlatList
                            keyExtractor={(item, index) => index.toString()}
                            data={props.restroDetail.popular_dish && props.restroDetail.popular_dish}
                            horizontal={true}
                            showsHorizontalScrollIndicator={false}
                            renderItem={({ item, index }) => props._handlePopularDish(item, index)
                            }
                        />
                    </View>
                    <View style={styles.LocationContainer}>
                        <View style={styles.LocationTxtView}>
                            ...
                            <TouchableOpacity
                                onPress={() => props.handleGetDirections(props.restroDetail && props.restroDetail.latitude, props.restroDetail && props.restroDetail.longitude)}>
                        ...
                        <Text style={styles.ChoosedLocationTxt}>{props.restroDetail && props.restroDetail.address}</Text>
                        <View style={styles.DaysContainer}>
                            <FlatList
                                keyExtractor={(item, index) => index.toString()}
                                data={props.restroDetail.business_service_time && props.restroDetail.business_service_time}
                                renderItem={({ item, index }) =>
                    ...
                    <View style={styles.PopularDishContain}>
                        ...
                        <FlatList
                            keyExtractor={(item, index) => index.toString()}
                            data={props.restroDetail && props.restroDetail.image && props.restroDetail.image}
                            horizontal={true}
                    ...
                    <View style={styles.AboutBusinessContain}>
                        ...
                        <View style={styles.UserContainer}>
                            <Image style={styles.UserProfileStyle} source={{ uri: props.restroDetail && props.restroDetail.logo }} />
                            <View style={{ paddingLeft: 20 }}>
                                <Text style={styles.CovidMainTxt}>{props.restroDetail && props.restroDetail.business_user_name}</Text>
                    ...
                    <View style={styles.ReviewFullList}>
                        ...
                        <FlatList
                            keyExtractor={(item, index) => index.toString()}
                            data={props.restroDetail && props.restroDetail.business_review && props.restroDetail.business_review}
                            showsHorizontalScrollIndicator={false}
                    ...
                    <Dialog
                        ...
                        footer={
                            <TouchableOpacity onPress={() => props.setDialogVisible(false)}
                    ...
                    >
                        <DialogContent>
                            <View style={styles.MainContent}>
                                <TouchableOpacity onPress={() => props.setDialogVisible(false)} style={styles.ArrowTouchable}>
