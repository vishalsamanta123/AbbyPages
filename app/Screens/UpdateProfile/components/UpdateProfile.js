            ...
            <View style={[CommonStyles.body]}>
                ...
                <ScrollView keyboardShouldPersistTaps={"always"}>
                    <View style={[styles.MainContainer, { paddingTop: '15%' }]}>
                        <Input
                            onChangeText={(first_name) => props.setProfileData({
                                ...props.profileData,
                        ...
                        />
                        <Input
                            onChangeText={(last_name) => props.setProfileData({
                                ...props.profileData,
                                last_name: last_name
                            })}
                        ...
                        />
                        <Input
                            onChangeText={(nick_name) => props.setProfileData({
                                ...props.profileData,
                                nick_name: nick_name
                            })}
                        ...
                        />
                        {/* gender */}
                        <View style={[styles.container, { paddingHorizontal: 10, flexDirection: "column" }]}>
                            {
                                props.profileData.gender !== 0 &&
                                <Text style={[styles.AddPhotosTxt, { fontSize: 17 }]}>Gender</Text>
                            }
                            <Picker
                                selectedValue={`${props.profileData.gender}`}
                                style={styles.CameraImgView}
                                onValueChange={(itemValue, itemIndex) => props.setProfileData({
                                    ...props.profileData,
                                    gender: itemValue
                                })}>
                        ...
                        />
                        <Input
                            onChangeText={(zip_code) => props.setProfileData({
                                ...props.profileData,
                                zip_code: zip_code
                            })}
                        ...
                        />
                        <Input
                            onChangeText={(headline) => props.setProfileData({
                                ...props.profileData,
                                headline: headline
                            })}
                        ...
                        />
                        <Input
                            onChangeText={(i_love) => props.setProfileData({
                                ...props.profileData,
                                i_love: i_love
                            })}
                        ...
                        <GooglePlacesAutocomplete
                            placeholder={props.profileData.find_me_in && props.profileData.find_me_in ? props.profileData.find_me_in : 'Find me in'}
                            fetchDetails={true}
                        ...
                        />
                        <GooglePlacesAutocomplete
                            placeholder={props.profileData.hometown && props.profileData.hometown
                                ? props.profileData.hometown : 'Home town'}
                            fetchDetails={true}
                            onPress={(data, details = null) => {
                                props.setProfileData({
                                    ...props.profileData,
                        ...
                        <Input
                            onChangeText={(blog_website) => props.setProfileData({
                                ...props.profileData,
                        ...
                        />
                        <Input
                            onChangeText={(when_not_on_abbypages) => props.setProfileData({
                                ...props.profileData,
                        ...
                        />
                        <Input
                            onChangeText={(why_should_read_my_reviews) => props.setProfileData({
                                ...props.profileData,
                        ...
                        />
                        <Input
                            onChangeText={(second_website) => props.setProfileData({
                                ...props.profileData,
                        ...
                        />
                        <Input
                            onChangeText={(great_book_read) => props.setProfileData({
                                ...props.profileData,
                        ...
                        />
                        <Input
                            onChangeText={(concert) => props.setProfileData({
                                ...props.profileData,
                                concert: concert
                            })}
                        ...
                        />
                        <Input
                            onChangeText={(favorite_movie) => props.setProfileData({
                                ...props.profileData,
                        ...
                        />
                        <Input
                            onChangeText={(last_meal_on_earth) => props.setProfileData({
                                ...props.profileData,
                        ...
                        />
                        <Input
                            onChangeText={(anyone_else_but) => props.setProfileData({
                                ...props.profileData,
                        ...
                        />
                        <Input
                            onChangeText={(most_recent_discovery) => props.setProfileData({
                                ...props.profileData,
                        ...
                        />
                        <Input
                            onChangeText={(current_crush) => props.setProfileData({
                                ...props.profileData,
                        ...
                        <View style={[styles.container, { paddingHorizontal: 8, flexDirection: "column" }]}>
                            {
                                props.profileData.primary_language !== null &&
                                <Text style={[styles.AddPhotosTxt, { fontSize: 17 }]}>Primary Language</Text>
                            }
                            <Picker
                        ...
                        <Button
                            buttonLabelStyle={{ color: WHITE_COLOR_CODE, fontFamily: FONT_FAMILY_BOLD }}
                            buttonText="Cancel"
