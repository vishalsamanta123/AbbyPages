...
import { SMALL_TEXT_COLOR_CODE, LINE_COMMON_COLOR_CODE, WHITE_COLOR_CODE, YELLOW_COLOR_CODE, FONT_FAMILY_REGULAR, GREY_COLOR_CODE } from '../../../Utils/Constant';
            ...
            >
                ...
                <View style={styles.DishDiscptnView}>
                    ...
                    <Text style={[styles.text, { fontSize: 12.5, color: SMALL_TEXT_COLOR_CODE }]}>
                        Design for simplicity and made from
                ...
                <ScrollView>
                    {
                        ...
                        <Image
                            ...
                            resizeMode='stretch'
                            source={{
                                uri: props.orderDetail.business_image && props.orderDetail.business_image
                            }}
                        />
                    }
                    <View
                        ...
                        <Text style={[styles.text, { fontSize: 15 }]}>
                            <Text style={[styles.text, {
                                fontSize: 13, color: SMALL_TEXT_COLOR_CODE
                            }]}>
                                Order Id :
                            </Text>
                        ...
                        <Text style={[styles.text, { fontSize: 15 }]}>
                            ...
                            {props.orderDetail.order_status === 3 && ' Cancelled By Business'}
                    ...
                    {props.orderDetail.business_type == 1 &&
                        <>
                            ...
                            <FlatList
                                data={props.orderDetail && props.orderDetail.item && props.orderDetail.item}
                                ...
                                </View> */}
                            {
                                ...
                                <View style={{ padding: 20 }}>
                                    ...
                                    <View style={{}}>
                                        <View style={{ flexDirection: "row" }}>
                                            <Image
                                                tintColor={props.orderDetail.order_process == 1 ? YELLOW_COLOR_CODE : '#c1bcbc'}
                                        ...
                                        <View style={{ flexDirection: "row", alignItems: 'flex-end' }}>
                                            <Image
                                                tintColor={props.orderDetail.order_process == 2 ? YELLOW_COLOR_CODE : '#c1bcbc'}
                                        ...
                                        <View style={{ flexDirection: "row", alignItems: 'flex-end' }}>
                                            <Image
                                                tintColor={props.orderDetail.order_process == 3 ? YELLOW_COLOR_CODE : '#c1bcbc'}
                                                source={require('../../../Assets/final_order.png')}
                                            />
                                            <Text style={[styles.text, { fontSize: 15 }]}>
                                                Shipped
                                        ...
                                        <View style={{ flexDirection: "row", alignItems: 'flex-end' }}>
                                            <Image
                                                tintColor={props.orderDetail.order_process == 4 ? YELLOW_COLOR_CODE : '#c1bcbc'}
                                                source={require('../../../Assets/final_order.png')}
                                            />
                                            <Text style={[styles.text, { fontSize: 15 }]}>
                                                Delievered
