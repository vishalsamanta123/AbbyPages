                    ...
                    <View style={{ flex: 2, }}>
                        <View style={styles.firstimgvwe}>
                            <Image
                                ...
                                source={
                                    require('../../../Assets/success_icon.png')
                                }
                            />
                        </View>
                        <View style={styles.maintxtimg}>
                            <Text style={styles.firstlinetxt}> Your request has been sent! </Text>
                            <Text style={styles.frstlinesmltxt}>
                                BV Electric and other bussiness have recieved
                                your request.
                            </Text>
                        </View>
                    </View>
                    <View style={styles.centerlinvwe}>
                    </View>
                    <View style={styles.bdymnvwe}>
                            ...
                            <View style={styles.frstmnbxvwe}>
                                <Text style={styles.viaemailtxt}>
                                    You'll get a response via
                                    email, usally within 24
                                    hours.
                                     You'll get a response via
                                    email, usally within 24
                                    hours.
