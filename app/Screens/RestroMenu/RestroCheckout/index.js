...
import { Image, View, Text, Alert, TouchableOpacity, BackHandler } from 'react-native';
    ...
    const _handleLocationList = (item, index) => {
        return (
            <TouchableOpacity
                ...
                <Text style={[styles.AddressTextStyle]}>{item.location && item.location}</Text>
            </TouchableOpacity>
        );
    };
