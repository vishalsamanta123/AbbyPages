        ...
        <KeyboardAvoidingView style={[CommonStyles.container]}>
            ...
            <View style={[CommonStyles.body, { backgroundColor: WHITE_COLOR_CODE }]}>
                <ScrollView style={{ flexGrow: 1 }}>
                    <View>
                        <Image resizeMode='contain' style={[styles.MainImgeStyle]}
                            source={{ uri: props.ItemDetail.item_image }} />
                    </View>
                    <View style={styles.ContainerStyle}>
                        <Text style={styles.DishNameTxt}>{props.ItemDetail.item_name}</Text>
                        <Text style={styles.DesrcptnText}>{props.ItemDetail.description}</Text>
                    ...
                    <InputSpinner
                        ...
                        buttonPressStyle={{ height: 70, width: 80, backgroundColor: YELLOW_COLOR_CODE }}
                        buttonStyle={{ height: 70, width: 80, justifyContent: 'center', backgroundColor: YELLOW_COLOR_CODE }}
                        buttonFontFamily={FONT_FAMILY_REGULAR}
                        style={styles.AddBtnTouchable}
                    />
                    <TouchableOpacity
                        onPress={() => props.onPressSpiceLevel()} style={{
                            marginTop: 10,
                            marginBottom: 10,
                            borderColor: '#d8d8d8',
                            borderWidth: 1,
                    ...
                    {props.ShowSpiceLevel && props.ShowSpiceLevel ?
                        <View style={{
                            ...
                            <TouchableOpacity onPress={() => props.onPressSpiceLevelValue('Low')} style={{ padding: 5 }}>
                                <Text style={{
                            ...
                            <TouchableOpacity onPress={() => props.onPressSpiceLevelValue('Medium')} style={{ padding: 5 }}>
                                <Text style={{
                                    borderBottomColor: '#d8d8d8',
                                    borderBottomWidth: 1,
                                    paddingVertical: 5
                            ...
                            <TouchableOpacity onPress={() => props.onPressSpiceLevelValue('High')} style={{ padding: 5 }}>
                                <Text style={{
                                    borderBottomColor: '#d8d8d8',
                                    borderBottomWidth: 1,
                                    paddingVertical: 5
                    ...
                    />
                    <Button
                        buttonText={props.totalItemPrice && props.totalItemPrice ? ('Add To Cart - $' + props.totalItemPrice) : 'Add To Cart'}
