...
import { TextInput, Image, TouchableOpacity, View, Text, FlatList, ScrollView } from 'react-native';
            ...
            <View style={[CommonStyles.body]}>
                ...
                <ScrollView>
                    ...
                    <Button style={{ marginBottom: 20 }}
                        ...
                        buttonText={props.totalAmount
                            && props.totalAmount ? ('Checkout - $' + props.totalAmount) : 'Checkout'} />
                </ScrollView>
            </View>
        </View>
    );
