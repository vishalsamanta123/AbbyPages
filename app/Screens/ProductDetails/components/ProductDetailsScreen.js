...
import {
    BLACK_COLOR_CODE, YELLOW_COLOR_CODE, WHITE_COLOR_CODE,
    FONT_FAMILY_REGULAR, SMALL_TEXT_COLOR_CODE
} from '../../../Utils/Constant';
            ...
            <View style={[CommonStyles.body]}>
                <ScrollView>
                    ...
                    <View style={styles.infocon}>
                        ...
                        <View style={styles.basiccon}>
                            <View style={[styles.basiccon, { marginRight: 15 }]}>
                                <Text style={[styles.hdngtxt, { width: null, fontSize: 20, lineHeight: 24 }]}>
                        ...
                        <View style={styles.basiccon}>
                            ...
                            {props.productDetail.rating == 3 &&
                                <>
                                    ...
                                    />
                                    <Image
                                        style={[styles.icon, { marginRight: 5, height: 18, width: 18 }]}
                                        source={require('../../../Assets/extraImages/rating-star-icon-yellow.png')}
                                    />
                                    <Image
                                        style={[styles.icon, { marginRight: 5, height: 18, width: 18 }]}
                        ...
                        <View
                            ...
                            {props.addButton ?
                                <InputSpinner
                                    ...
                                    onDecrease={(val) => props.removeFromCart(props.productDetail, val)}
                                    onIncrease={(val) => props.addProductOnCart(props.productDetail, val)}
                                    // min={1}
                                    max={10}
                                    step={1}
                                    editable={false}
                                    ...
                                    buttonPressStyle={{ height: 100, width: 100, backgroundColor: YELLOW_COLOR_CODE }}
                                    buttonStyle={{ height: 100, width: 100, justifyContent: 'center', }}
                    ...
                    <View style={[styles.maincontainers, { borderBottomWidth: 0 }]}>
                        ...
                        <FlatList
                            data={props.productDetail.product_review && props.productDetail.product_review}
                            keyExtractor={(item, index) => index}
                            renderItem={({ item, index }) =>
                                <View style={[styles.basiccon, {
                                    ...
                                    <View style={{ flex: 1, flexDirection: "row", }}>
                                        ...
                                        <View style={{ flex: 4.7 }}>
                                            <Text style={[styles.hdngtxt, { fontSize: 15.5, lineHeight: 19.9 }]}>
                                                {item.title}
                                            </Text>
                                            <View style={[styles.basiccon,]}>
                                                <Text style={[styles.text, { fontSize: 13, lineHeight: 17 }]}>
                                                    by
                                                </Text>
                                                <Text
                                                    numberOfLines={1}
                                                    style={[styles.text, {
                                                        ...
                                                        paddingLeft: 5, lineHeight: 17, width: "50%"
                                                    }]}>
                                                    {item.first_name + ' ' + item.last_name}
                                                </Text>
                                                <Text style={[styles.text, { paddingLeft: 5, fontSize: 13, lineHeight: 17 }]}>
                                                    {/* 15 hours ago */}
                                                    {' | ' + moment(item.create_date, "YYYY-MM-DD,h:mm:ss a").fromNow()}
                                                </Text>
                                            </View>
                                            {/* <View style={[styles.basiccon,]}>
                                                <Text style={[styles.hdngtxt, {
