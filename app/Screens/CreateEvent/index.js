...
import { View, Dimensions, TouchableOpacity, FlatList, Image } from 'react-native';
...
const CreateEventView = () => {
    ...
    const onPressCreateEvent = async () => {
        ...
        try {
            ...
            const response = await apiCall('POST', ENDPOINTS.CREATE_EVENTS,
