...
import { SMALL_TEXT_COLOR_CODE, WHITE_COLOR_CODE, YELLOW_COLOR_CODE, FONT_FAMILY_REGULAR } from '../../../Utils/Constant';
            ...
            <View style={[CommonStyles.body,{backgroundColor:WHITE_COLOR_CODE}]}>
                ...
                <View style={styles.firsttextvwe}>
                    <Text style={styles.firstxt}>
                        You can share your project details  with other
                            recommended bussinesses to help choose the one 
                ...
                <View style={styles.centerbtntxt}>
                    <TouchableOpacity 
                        onPress={() => props.setServiceProvideType(!props.service_provide_type)}
                    style={{
                        flexDirection:"row",
                        height:70,
                        backgroundColor: props.service_provide_type?YELLOW_COLOR_CODE:WHITE_COLOR_CODE,
                        borderWidth: !props.service_provide_type ? 1 : 0,
                        alignItems:"center",
                        width:'90%',alignSelf:"center",
                        borderRadius:10,justifyContent:"space-around"
                        }}>
                        ...
                        <Image
                        source={require('../../../Assets/check_icon_btn.png')}
                        />
                        }
                    </TouchableOpacity>
                    <TouchableOpacity 
                    ...
                    style={{
                        ...
                        alignItems:"center",
                        width:'90%',alignSelf:"center",
                        borderRadius:10,justifyContent:"space-around",marginTop:10
                        }}>
                        <Text style={{fontFamily:FONT_FAMILY_REGULAR,fontSize:20}}>
                ...
                <View style={styles.boximgvwe}>
                    <View style={styles.imgvwe}>
                        <TouchableOpacity onPress={props.goBack} >
                            <Image style={styles.mainboximg} source={require('../../../Assets/Group1672.png')} />
                        </TouchableOpacity>
                    </View>
                </View>
