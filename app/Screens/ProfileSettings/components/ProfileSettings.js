            ...
            <View style={[CommonStyles.body]}>
                <ScrollView>
                    <View style={styles.MainContainer}>
                        <TouchableOpacity onPress={() => props.onPressProfile()} style={styles.container}>
                        ...
                        {userData && userData.data && userData.data.signup_mode === 0 &&
                            <TouchableOpacity onPress={() => props.onPressPassword()} style={styles.container}>
                                <View style={styles.CameraImgView}>
                        ...
                        <TouchableOpacity onPress={() => props.onPressEmail()} style={styles.container}>
                            <View style={styles.CameraImgView}>
                                <Image source={require('../../../Assets/envelope_icon_menu.png')} />
                            </View>
                            <View style={styles.TextContainer}>
                        ...
                        <TouchableOpacity onPress={() => props.onPressLocations()} style={styles.container}>
                            <View style={styles.CameraImgView}>
                                <Image source={require('../../../Assets/marker_icon_menu.png')} />
                            </View>
                            <View style={styles.TextContainer}>
                        ...
                        <TouchableOpacity onPress={() => props.onPressSettings()} style={styles.container}>
                            <View style={styles.CameraImgView}>
                                <Image source={require('../../../Assets/settings_icon_menu.png')} />
                            </View>
                            <View style={styles.TextContainer}>
                    ...
                    <View style={[styles.MainContainer, { marginTop: 10, paddingLeft: 15 }]}>
                        <Text style={[styles.AddPhotosTxt, { fontSize: 19, paddingLeft: 0 }]}>
                            About {props.userProfileData && props.userProfileData.first_name + ' ' + props.userProfileData.last_name}</Text>
                        <View style={styles.LocationView}>
                            <Text style={styles.LoctionTextStyle}>Location</Text>
                            <Text style={styles.LocationNameTXt}>{props.userProfileData.find_me_in}</Text>
                        </View>
                        <View style={styles.LocationView}>
                        ...
                        <View style={styles.LocationView}>
                            ...
                            {props.userProfileData.i_love ?
                                <Text style={styles.LocationNameTXt}>{props.userProfileData && props.userProfileData.i_love}</Text>
                                :
                                <>
