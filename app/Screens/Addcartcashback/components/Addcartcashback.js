        ...
        <ScrollView>
          ...
          <View style={styles.ContainerView}>
            ...
            <Text style={styles.ParaTextStyle}>
              By clicking on "link Card a. S.rt Earning", I agree that
              AbbyPages, Empyr (a service provider to AbbyPages), participating
              merchants and card networks (Visa, Mastercard and American
              Express) May use and share detaiLs of my transactions made at
              participating merchants to calcuLate points, redeem rewards a.
              otherwise faciLitate my participation in AbbyPages Cash Back, and
              that Abbypages may target offers that be of interest me, all as
              set forth in the{" "}
