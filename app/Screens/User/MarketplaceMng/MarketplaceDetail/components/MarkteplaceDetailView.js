...
const MarkteplaceDetailView = (props) => {
  ...
  const productSpecification = productDetail
    ? JSON.parse(productDetail?.product_specification)
    : {};
  console.log(
    "🚀 ~ file: MarkteplaceDetailView.js:17 ~ productSpecification:",
    ...
    <View style={[CommonStyles.container, { paddingHorizontal: 20 }]}>
      ...
      >
        ...
        <View style={[styles.sendmsgView]}>
          <ScaleText style={styles.sendMsgTxt}>Send seller a message</ScaleText>
        ...
        <View style={styles.sellerInfoView}>
          <ScaleText style={styles.sellerInfoTxt}>Seller Information</ScaleText>
        ...
        <View style={styles.sellerInfoView}>
          ...
          {productSpecification?.parking_availability ? (
            <View style={styles.detailView}>
              <ScaleText style={styles.keyTxt}>Parking Availability</ScaleText>
              <ScaleText style={styles.valueTxt}>
                {productSpecification?.parking_availability}
              </ScaleText>
            </View>
          ...
          {productSpecification?.property_description ? (
            <View style={styles.detailView}>
              <ScaleText style={styles.keyTxt}>Property description</ScaleText>
              <ScaleText style={styles.valueTxt}>
                {productSpecification?.property_description}
              </ScaleText>
            </View>
          ...
          <>
            ...
            <View style={styles.detailView}>
              <ScaleText style={styles.descTxt}>
                {productSpecification?.descriptions}
                sdhubvsbivils oaibugiobrgiub ijub iujboilaub vgluvb liuvbla kuivlkuiv lkiuvui
              </ScaleText>
            </View>
          </>
        ) : null}
