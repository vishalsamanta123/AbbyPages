            ...
            <View style={[CommonStyles.body, { flex: 5.4, backgroundColor: WHITE_COLOR_CODE }]}>
                ...
                >
                    ...
                    <View style={styles.ButtonContainer}>
                        ...
                        />
                        <TouchableOpacity onPress={() => props.onPressSignUp()} style={{ paddingTop: 10 }}>
                            <Text style={styles.CreateAccountTxt}>Not Registered yet? Create new account <Text style={styles.SignUpTtx}>SignUp</Text></Text>
                        </TouchableOpacity>
                    </View>
                </ScrollView>
            </View>
