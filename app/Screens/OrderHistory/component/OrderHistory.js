    ...
    console.log('item: ', item);
        return (
            <TouchableOpacity style={styles.ConatinView}
                onPress={() =>
                    item.order_booking_type == 1 ? props.onpressOrder(item) : console.log(item)}
                    ...
                    <View style={{ flexDirection: "row" }}>
                        <View style={{ flex: 1 }}>
                            {item.total_amount &&
                                <View style={styles.DateContainer}>
                                    ...
                                    <Text style={[styles.ReviewText, { paddingLeft: 5, fontSize: 14 }]}>{item.total_amount}</Text>
                                </View>
                            }
                        ...
                        <View style={{ justifyContent: "center", alignItems: "flex-end", flex: 1 }}>
                            <TouchableOpacity
                                ...
                                style={{ backgroundColor: YELLOW_COLOR_CODE, padding: 8, borderRadius: 30 }}
                            >
                                <Image
    ...
    return (
        <View style={CommonStyles.container}>
            ...
            <View style={[CommonStyles.body]}>
                <View style={[styles.FlatlistContain, { flexDirection: "row", backgroundColor: YELLOW_COLOR_CODE }]}>
                    <TouchableOpacity
                ...
                {props.orderItemList && props.orderItemList ?
                    <View style={[styles.FriendContainer]}>
                        <FlatList
                            data={props.orderItemList && props.orderItemList}
                            keyExtractor={(item, index) => index}
                    ...
                    <View style={[styles.FriendContainer, {
                        ...
                        <View style={[styles.cardCon]}>
                            <View style={styles.imgCon}>
                                <Image source={require('../../../Assets/order_icon_box_large.png')} />
                            </View>
