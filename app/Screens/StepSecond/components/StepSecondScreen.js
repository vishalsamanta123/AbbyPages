...
import { YELLOW_COLOR_CODE, GREY_COLOR_CODE, FONT_FAMILY_REGULAR, BLACK_COLOR_CODE } from '../../../Utils/Constant';
                ...
                {props.queAnsData ?
                    <View style={{ flex: 1, }}>
                        <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
                            <Text style={{
                                fontFamily: FONT_FAMILY_REGULAR, fontSize: 18,
                                textAlign: "center", paddingVertical: 10,
                                paddingHorizontal: 15,// paddingTop: 50,
                            }}>
                                {props.queAnsData && props.queAnsData.question && props.queAnsData.question.question}
                            </Text>
                        </View>
                        <View style={{ flex: 4 }}>
                            <FlatList
                                ...
                                renderItem={({ item, index }) => {
                                    return (
                                        <TouchableOpacity
                                            ...
                                            onPress={() => { props.setSelectedAnswer(item) }}
                                            key={index}
                                            style={{
                                                // margin: 5,
                                                padding: 5,
                                        ...
                                        >
                                            <View style={{ paddingHorizontal: 10 }}>
                                                {
                                                    props.selectedAnswer.question_ans_id == item.question_ans_id ?
                                                        <Image
                                                            resizeMode='contain'
                        ...
                        <View style={[styles.lastFootervwe, {}]}>
                            <Button
                                ...
                                onPress={() => { props.setQueAnsData(''), props.setServiceProviderQueAnsData(''), props.setServiceProviderData('') }}
                            />
                            <Button
                                buttonText="Next"
                                style={styles.btnvwe}
                            ...
                            renderItem={({ item, index }) => {
                                return (
                                    <TouchableOpacity
                                        ...
                                        <Image style={[styles.Allgrpimg, {
                                            borderWidth:
                                                props.selectedCategory.category_id == item.category_id ? 2 : 0.2,
                                            borderColor:
                                                props.selectedCategory.category_id == item.category_id ? YELLOW_COLOR_CODE : GREY_COLOR_CODE
                                        }]}
