      ...
      <View style={CommonStyles.body}>
        <ScrollView>
          <View style={styles.ImageContainer}>
            ...
            >
              {props?.profileData ? (
                props?.profileData?.business_imgae?.map((item, imageIndex) => {
                  return (
                    <View
            ...
            <View style={styles.BuildingImge}></View>
          ...
          <View style={styles.BookMarkContainer}>
            ...
            <Text style={styles.CategoriesDcptnText}>
              Customers use this information to find your business on AbbyPages
            ...
            <View style={styles.ViewContainer}>
              ...
              <View style={styles.ViewParagrapgh}>
                <Text style={styles.ParagrapghTextMain}>
                  ...
                  customers, as your business will only show up in searches for
            ...
            <View style={styles.ViewContainer}>
              ...
              <View style={styles.ViewParagrapgh}>
                <Text style={styles.ParagrapghTextMain}>
                  ...
                  evaluate a business. Make sure your photos show your business
                  at its best.
                </Text>
                <TouchableOpacity>
            ...
            <View style={styles.ViewContainer}>
              ...
              <View style={styles.ViewParagrapgh}>
                <Text style={styles.ParagrapghTextMain}>
                  ...
                  photos and videos to leat with your best.
                </Text>
                <TouchableOpacity>
            ...
            <View style={styles.ViewContainer}>
              ...
              <View style={styles.ViewParagrapgh}>
                <Text style={styles.ParagrapghTextMain}>
                  ...
                  connect with you in a way that aligns with your goals.
                </Text>
                <TouchableOpacity>
                  <Text style={styles.YellowText}>Learn More</Text>
                </TouchableOpacity>
          ...
          <View style={styles.BookMarkContainer}>
            ...
            {props.profileData ? (
              props.profileData.changing_tables == 1 ? (
                <Text style={styles.BusinessHighlight}>Has Tv</Text>
              ) : null
            ) : null}
            {props.profileData ? (
              props.profileData.alcohol == 1 ? (
            ...
            {props.profileData ? (
              props.profileData.offers_delivery == 1 ? (
                <Text style={styles.BusinessHighlight}>Offer Delivery</Text>
              ) : null
            ) : null}
            {props.profileData ? (
              props.profileData.service_area == 1 ? (
                <Text style={styles.BusinessHighlight}>Service Area</Text>
              ) : null
            ) : null}
            {props.profileData ? (
              props.profileData.accept_credit_card == 1 ? (
                <Text style={styles.BusinessHighlight}>
                  Accept Credit Cards
                </Text>
              ) : null
            ) : null}
            {props.profileData ? (
              props.profileData.takes_reservations == 1 ? (
                <Text style={styles.BusinessHighlight}>Takes Reservations</Text>
              ) : null
            ) : null}
            {props.profileData ? (
              props.profileData.caters == 1 ? (
                <Text style={styles.BusinessHighlight}>Caters</Text>
              ) : null
            ) : null}
            {props.profileData ? (
              props.profileData.wi_fi == 1 ? (
                <Text style={styles.BusinessHighlight}>Wifi</Text>
              ) : null
            ) : null}
            {props.profileData ? (
              props.profileData.offers_military_discount == 1 ? (
                <Text style={styles.BusinessHighlight}>
            ...
            {props.profileData ? (
              props.profileData.good_for_happy_hour == 1 ? (
                <Text style={styles.BusinessHighlight}>
                  Good For Happy Hour
                </Text>
              ) : null
            ...
            {props.profileData ? (
              props.profileData.wheelchair_accessible == 1 ? (
                <Text style={styles.BusinessHighlight}>
            ...
            {props.profileData ? (
              props.profileData.dogs_allowed == 1 ? (
                <Text style={styles.BusinessHighlight}>Dogs Allowed</Text>
              ) : null
            ) : null}
            {props.profileData ? (
              props.profileData.accept_cryptocurrency == 1 ? (
                <Text style={styles.BusinessHighlight}>
            ...
            {props.profileData ? (
              props.profileData.outdoor_seating == 1 ? (
                <Text style={styles.BusinessHighlight}>Outdoor Seating</Text>
              ) : null
            ) : null}
            {props.profileData ? (
              props.profileData.gender_neutral_restrooms == 1 ? (
                <Text style={styles.BusinessHighlight}>
            ...
            {props.profileData ? (
              props.profileData.masks_required == 1 ? (
                <Text style={styles.BusinessHighlight}>Masks Required</Text>
              ) : null
            ) : null}
            {props.profileData ? (
              props.profileData.contactless_payments == 1 ? (
                <Text style={styles.BusinessHighlight}>
            ...
            {props.profileData ? (
              props.profileData.high_chairs == 1 ? (
            ...
            {props.profileData ? (
              props.profileData.black_owned == 1 ? (
            ...
            <View style={styles.ViewContainer}>
              <View>
                <Text style={styles.ParagrapghTextMain}>
                  Stand out when customers are looking for businesses like
                  yours. Choose from 30+ badges to highlight what makes you
                  unique.
                </Text>
                <TouchableOpacity>
                  <Text style={styles.YellowText}>Learn More</Text>
