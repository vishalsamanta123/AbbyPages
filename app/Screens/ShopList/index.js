...
const ShopList = ({ navigation }) => {
    ...
    const _handleShopList = (item) => {
        return (
            <TouchableOpacity onPress={() => onPressShop(item)} style={[{ flexDirection: "row", alignSelf: 'center', marginVertical: 5 }]}>
                <View style={{ flex: 2 }}>
                    <Image style={styles.MainImgeStyle}
                        resizeMode='contain'
                        source={{
                            uri: item.logo
                        }} />
                ...
                <View style={[{ flex: 4, paddingRight: 5 }]}>
                    ...
                    <Text numberOfLines={1} style={[styles.AddressTextStyles, { paddingRight: 5 }]}>{item.business_service_category}</Text>
                    <View style={[styles.InformationView, { paddingVertical: 2 }]}>
                        ...
                        <Text numberOfLines={1} style={[styles.AddressTextStyles, { paddingRight: 10, lineHeight: 14 }]}> {item.address}</Text>
                    </View>
                    <View style={styles.InformationView}>
                        <Text numberOfLines={1} style={[styles.AddressTextStyles, {paddingVertical:1 }]}>{item.about_business}</Text>
    ...
    const onPressMap = () => {
        navigation.navigate('ListingMap', { businessList: shopList, business_type: 2 })
    };
