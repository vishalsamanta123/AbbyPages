...
const EventListingScreen = (props) => {
    const _renderCategory = (item, index) => {
        ...
        return (
            <TouchableOpacity onPress={() => props?._handleDataTypeSelected(index, item)}
            ...
            <TouchableOpacity onPress={() => props.onPressEvent(item)} style={styles.mnCon}>
                <ImageBackground style={styles.bannerimg} source={{ uri: item.events_image }}>
                    <View style={styles.btncon}>
                        <Text style={{ fontFamily: FONT_FAMILY_REGULAR, lineHeight: 16 }}>Buy Tickets</Text>
                    </View>
                </ImageBackground>
                <View style={styles.infobox}>
                    ...
                    <Text style={[styles.text, {
                        padding: 5, paddingBottom: 8, lineHeight: 18
                    }]}>
                    ...
                    <View style={styles.intcon}>
                        ...
                        <Text style={[styles.text, { lineHeight: 16 }]}>{item.interested} interested</Text>
                    </View>
                </View>
            </TouchableOpacity>
        )
