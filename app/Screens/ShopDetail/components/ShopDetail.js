...
const ShopDetail = (props) => {
    const initialRegion = {
        latitude: props.shopDetail.latitude ? parseInt(props.shopDetail.latitude) : 22.724480,
        longitude: props.shopDetail.longitude ? parseInt(props.shopDetail.longitude) : 75.889267,
        latitudeDelta: 0.015,
            ...
            <View style={[CommonStyles.body]}>
                <ScrollView>
                    ...
                    <View style={styles.RestroDetailView}>
                        <Text style={styles.RestroNameTxt}>{props.shopDetail && props.shopDetail.business_name}</Text>
                        <View style={styles.FlexRowView}>
                            <Text style={styles.RateTextStyle}>
                                {props.shopDetail && props.shopDetail.business_star === 0 && '$ | '}
                                {props.shopDetail && props.shopDetail.business_star === 1 && '$  | '}
                                {props.shopDetail && props.shopDetail.business_star === 2 && '$$  | '}
                                {props.shopDetail && props.shopDetail.business_star === 3 && '$$$  | '}
                                {props.shopDetail && props.shopDetail.business_star === 4 && '$$$$  | '}
                                {props.shopDetail && props.shopDetail.business_star === 5 && '$$$$$  | '}
                            </Text>
                            {/* <FlatList
                                keyExtractor={(item, index) => index.toString()}
                            ...
                            /> */}
                            <Text style={styles.RateTextStyle}>{props.shopDetail && props.shopDetail.business_service_category}</Text>
                        </View>
                        <View style={styles.RatingContainer}>
                            <View style={styles.RatingStyles}><Text style={styles.RatingStylesTxt}>5.0</Text></View>
                            <Text style={styles.RatingTextMain}> {props.shopDetail && props.shopDetail.rating}  ratings | </Text>
                            <Text style={styles.MainClosedTime}>
                                {
                                    props.shopDetail && props.shopDetail.login_status === 1 ? 'Open' : 'Closed'
                                }
                             :</Text>
                    ...
                    <View style={styles.MainUpdateContainer}>
                        ...
                        <View style={styles.CovidParaView}>
                            ...
                            <View style={{ flexDirection: "row" }}>
                                <View style={styles.UpdateOptions}>
                                    {props.shopDetail && props.shopDetail.accept_credit_card === 1 ?
                                        <View style={{}}>
                                            <ImageBackground
                                    ...
                                    <Text style={styles.OutDoorSeatingTxt}>Accepts Credit Cards</Text>
                                </View>
                                <View style={styles.UpdateOptions}>
                            ...
                            <View style={{ flexDirection: "row" }}>
                                ...
                                <View style={styles.UpdateOptions}>
                                    {props.shopDetail && props.shopDetail.offers_delivery === 1 ?
                                        <View style={{}}>
                                            <Image
                                                style={styles.RightImgeStyle}
                                                source={require('../../../Assets/text_check_icon.png')} />
                        ...
                        <View style={styles.CovidParaView}>
                            ...
                            <View style={{ flexDirection: "row" }}>
                                ...
                                <View style={styles.UpdateOptions}>
                                    {props.shopDetail && props.shopDetail.staff_wears_gloves === 1 ?
                                        <View>
                                            <Image style={styles.RightImgeStyle} source={require('../../../Assets/text_check_icon.png')} />
                                        </View>
                                        :
                    ...
                    <View style={styles.LocationContainer}>
                        ...
                        <Text style={styles.ChoosedLocationTxt}>{props.shopDetail && props.shopDetail.address}</Text>
                        <View style={styles.DaysContainer}>
                            <FlatList
                                keyExtractor={(item, index) => index.toString()}
                                data={props.shopDetail.business_service_time && props.shopDetail.business_service_time}
                                renderItem={({ item, index }) =>
                    ...
                    <View style={styles.PopularDishContain}>
                        ...
                        <FlatList
                            keyExtractor={(item, index) => index.toString()}
                            data={props.shopDetail && props.shopDetail.image && props.shopDetail.image}
                            horizontal={true}
                    ...
                    <View style={styles.AboutBusinessContain}>
                        ...
                        <View style={styles.UserContainer}>
                            <Image style={styles.UserProfileStyle} source={{ uri: props.shopDetail && props.shopDetail.logo }} />
                            <View style={{ paddingLeft: 20 }}>
                                <Text style={styles.CovidMainTxt}>{props.shopDetail && props.shopDetail.business_user_name}</Text>
                    ...
                    <View style={styles.ReviewFullList}>
                        ...
                        <FlatList
                            keyExtractor={(item, index) => index.toString()}
                            data={props.shopDetail && props.shopDetail.business_review && props.shopDetail.business_review}
                            showsHorizontalScrollIndicator={false}
