    ...
    return (
        <View style={CommonStyles.container}>
            <Header
                ...
                RightImg={null}
            />
            <View style={[CommonStyles.body, {paddingTop:25, backgroundColor: WHITE_COLOR_CODE }]}>
                <View style={{
                                            ...
                                            item.check === true ?
                                                <View style={{ padding: 3 }}>
                                                    <View style={{ flexDirection: 'row', margin: 2, justifyContent: 'center', borderWidth: 1, borderRadius: 5, borderColor: '#d8d8d8' }}>
                                                        ...
                                                        <TouchableOpacity onPress={() => props.RemoveService(index)} style={{ borderLeftWidth: 1, padding: 5, borderColor: '#d8d8d8' }}>
                                                            <Text>X</Text>
                                                        </TouchableOpacity>
                                                    </View>
                                                </View>
