    ...
    <View style={CommonStyles.container}>
      ...
      <View style={[CommonStyles.body, { backgroundColor: WHITE_COLOR_CODE }]}>
        <ScrollView>
          ...
          />
          <Input
            onChangeText={(productDiscount) =>
              props.setProductDiscount(productDiscount)
            }
          ...
          <Input
            onChangeText={(productQuanlity) =>
              props.setProductQuanlity(productQuanlity)
            }
          ...
          <Input
            onChangeText={(productFinalPrice) =>
              props.setProductFinalPrice(productFinalPrice)
            }
          ...
          <Input
            onChangeText={(productDescription) =>
              props.setProductDescription(productDescription)
            }
          ...
          <Input
            onChangeText={(productWeight) =>
              props.setProductWeight(productWeight)
            }
                  ...
                  <View style={styles.slctimguri}>
                    ...
                    >
                      <View style={styles.slcttch}>
                        <TouchableOpacity
                          onPress={() => props.localProductImgDelete(index)}
                          style={styles.slcttch}
                        >
                ...
                return (
                  <View style={styles.prdctvwe}>
                    ...
                    >
                      <View style={styles.slcttch}>
                        <TouchableOpacity
                          onPress={() => props.DeleteProductMsg(item)}
                          style={styles.slcttch}
                        >
                          <View style={styles.xtxt}>
                            <Text style={styles.xtetx}>X</Text>
