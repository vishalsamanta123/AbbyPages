...
const TableManagementView = ({ navigation }) => {
    ...
    const editTable = (item) => {
        navigation.navigate('AddTable', { TableData: item, type: 'Edit', ImgBaseUrl })
    }
            ...
            <TouchableOpacity onPress={() => editTable(item)} style={styles.MainContain}>
                ...
                <View style={styles.ViewContainer}>
                    ...
                    <View style={styles.settingPersonView}>
                        <Image style={styles.UserIcon} source={require('../../../Assets/following_icon_menu.png')} />
                        <Text style={styles.PersonText}>Sitting Person: {item.sitting_person}</Text>
                    </View>
                </View>
            </TouchableOpacity >
        )
