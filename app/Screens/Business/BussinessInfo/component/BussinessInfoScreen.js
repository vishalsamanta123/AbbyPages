        ...
        <View style={[CommonStyles.container]}>
            ...
            <View style={[CommonStyles.body, { backgroundColor: WHITE_COLOR_CODE }]}>
                ...
                <View style={{ height: 180 }}>
                    {props.profileData.latitude &&
                        ...
                        >
                            <MapView.Marker
                                coordinate={{
                                    'latitude': props.profileData ? parseInt(props.profileData.latitude) : 22.7196,
                                    'longitude': props.profileData ? parseInt(props.profileData.longitude) : 75.8577
                                }}
                            />
                        </MapView>
                    }
                ...
                <ScrollView>
                    <View style={styles.mainboxvwe}>
                        <View style={styles.secmainvwe}>
                            ...
                            <View style={styles.addvxvwe}>
                                ...
                                <Text style={styles.alladdtxt}>{props.profileData.address}</Text>
                            </View>
                        </View>
                    ...
                    <TouchableOpacity style={styles.mainboxvwe} onPress={() => props.navToBasicInfo()}>
                        <View style={styles.secmainvwe}>
                            <Image source={require('../../../../Assets/business_call_icon.png')} />
                            <View style={styles.addvxvwe}>
                    ...
                    <TouchableOpacity onPress={() => props.naviRestaurant()} style={styles.mainboxvwe}>
                        <View style={styles.secmainvwe}>
                            <Image source={require('../../../../Assets/business_menu_icon.png')} />
                            <View style={styles.addvxvwe}>
                                <Text style={styles.allicontxt}>Menu</Text>
                                <Text style={styles.alladdtxtyellowtxt}>Let your customers see what on the menu</Text>
                            </View>
                        </View>
                        <View style={styles.lastimvwe}>
                            <Image source={require('../../../../Assets/arrow_right_icon.png')} />
                    ...
                    <TouchableOpacity style={styles.mainboxvwe} onPress={() => props.navToBasicInfo()}>
                        <View style={styles.secmainvwe}>
                            ...
                            <View style={styles.addvxvwe}>
                                ...
                                <Text style={styles.alladdtxtyellowtxt}>Define which area you provide services for</Text>
                            </View>
                        </View>
                        <View style={styles.lastimvwe}>
                            <Image source={require('../../../../Assets/arrow_right_icon.png')} />
                    ...
                    <TouchableOpacity onPress={() => props.goalsFun()} style={styles.mainboxvwe}>
                        <View style={styles.secmainvwe}>
                            {/* <Image source={require('../../../../Assets/business_address_icon.png')} /> */}
                    ...
                    <TouchableOpacity onPress={() => props.AddKeybordFun()} style={styles.mainboxvwe}>
                        <View style={styles.secmainvwe}>
                    ...
                    <TouchableOpacity onPress={() => props.AddTextFun()} style={styles.mainboxvwe}>
                        <View style={styles.secmainvwe}>
                            <Image source={require('../../../../Assets/st_icon_4.png')} />
                            <View style={styles.addvxvwe}>
                    ...
                    <TouchableOpacity onPress={() => props.BusinessLocationFun()} style={styles.mainboxvwe}>
                        <View style={styles.secmainvwe}>
                            <Image resizeMode='center' style={{ height: 30, width: 30 }} source={require('../../../../Assets/Location_icon.png')} />
                            <View style={styles.addvxvwe}>
                    ...
                    <TouchableOpacity onPress={() => props.BudgetsFun()} style={styles.mainboxvwe}>
                        <View style={styles.secmainvwe}>
                            <Image resizeMode='center' style={{ height: 30, width: 30 }} source={require('../../../../Assets/budget_icon.jpeg')} />
                            <View style={styles.addvxvwe}>
