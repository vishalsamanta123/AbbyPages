    ...
    return (
        <KeyboardAvoidingView style={[CommonStyles.container]}>
            ...
            <View style={[CommonStyles.body, { backgroundColor: WHITE_COLOR_CODE }]}>
                <Image style={styles.TimeLineImge} source={require('../../../../Assets/loaction.png')} />
                <ScrollView>
                    ...
                    <View style={styles.selectOptionContain}>
                        <View style={[styles.WriteTextView, { paddingLeft: 0, paddingTop: 0 }]}>
                            ...
                            <View style={{ paddingTop: 5 }} >
                                <Text style={[styles.WriteText, { fontSize: 16 }]}><Text style={{ color: YELLOW_COLOR_CODE }}>{props.miles}</Text> miles</Text>
                                {/* <Slider 
                                    step={1}
                    ...
                    <View style={styles.EstimateView}>
                        ...
                        <Image style={{ top: 2 }} source={require('../../../../Assets/info_icon_circled.png')} />
                    </View>
                    <View style={styles.AudienceCOntain}>
                        ...
                        <View style={styles.HintView}>
                            ...
                            <Text style={styles.HintTextMain}>Targetting a small area can limit how often
                                your ad shown and lead to a higher cost-per-click
                            </Text>
                        </View>
                    </View>
                    <Button
