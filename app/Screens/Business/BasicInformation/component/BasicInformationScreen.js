            ...
            <View style={[CommonStyles.body]}>
                <ScrollView keyboardShouldPersistTaps={"always"} contentContainerStyle={{ flexGrow: 1 }}>
                    <View style={styles.inptvwe}>
                        <Input
                            onChangeText={(business_name) => props.setBasicInformationData({
                        ...
                        {props.address != 1 ? <View style={{
                            ...
                            <View style={{ marginTop: 10, marginBottom: 10 }}>
                                <GooglePlacesAutocomplete
                                    ...
                                    onChangeText={
                                        (address) => props.setBasicInformationData({
                                            ...props.BasicInformationData,
                        ...
                        <View style={styles.countryViewSty}>
                            <TouchableOpacity
                                ...
                                <Text style={{
                                    ...
                                    {props.countryName ? props.countryName : props.BasicInformationData.country_name ? props.BasicInformationData.country_name : 'Country'}
                                </Text>
                        ...
                        {props.CountrySta ?
                            <View style={[styles.flatlistViewSty, { height: props.CountryData ? props.CountryData.length > 0 ? 200 : 140 : 0, marginBottom: 8 }]}>
                                ...
                                {props.CountryData.length > 0 ?
                                    ...
                                    <View style={{ justifyContent: 'center', alignItems: 'center', height: 80 }}>
                                        <Text style={{ fontSize: 15, color: '#a9a9a9' }}>There is no country found</Text>
                                    </View>
                                }
                            </View>
                            :
                        ...
                        <View style={styles.countryViewSty}>
                            <TouchableOpacity
                                ...
                                <Text style={{
                                    ...
                                    {props.SiteName ? props.SiteName : props.BasicInformationData.state ? props.BasicInformationData.state : 'State'}
                                </Text>
                                <View style={{ paddingRight: 10 }}>
                                    {props.SiteSta ?
                                        <Image style={{ width: 25, height: 25 }}
                        ...
                        {props.SiteSta ?
                            <View style={[styles.flatlistViewSty, { height: props.SiteData.length > 0 ? 200 : 140, marginBottom: 8 }]}>
                                <View style={{ paddingLeft: 14, borderWidth: 1, borderRadius: 5, borderColor: "#a9a9a9" }}>
                                    <TextInput
                                ...
                                {props.SiteData.length > 0 ?
                                    ...
                                    :
                                    <View style={{ justifyContent: 'center', alignItems: 'center', height: 80 }}>
                                        <Text style={{ fontSize: 15, color: '#a9a9a9' }}>There is no state found</Text>
                                    </View>
                                }
                            </View>
                            :
                        ...
                        <View style={styles.countryViewSty}>
                            <TouchableOpacity
                                ...
                                <Text style={{
                                    ...
                                    {props.cityName ? props.cityName : props.BasicInformationData.city ? props.BasicInformationData.city : 'City'}
                                </Text>
                                <View style={{ paddingRight: 10 }}>
                                    {props.CitySta ?
                                        <Image style={{ width: 25, height: 25 }}
                        ...
                        {props.CitySta ?
                            <View style={[styles.flatlistViewSty, { height: props.CityData.length > 0 ? 200 : 140, marginBottom: 8 }]}>
                                <View style={{ paddingLeft: 14, borderWidth: 1, borderRadius: 5, borderColor: "#a9a9a9" }}>
                                    <TextInput
                                ...
                                {props.CityData.length > 0 ?
                                    ...
                                    :
                                    <View style={{ justifyContent: 'center', alignItems: 'center', height: 80 }}>
                                        <Text style={{ fontSize: 15, color: '#a9a9a9' }}>There is no city found</Text>
                                    </View>
                                }
                            </View>
                            :
                        ...
                        <Input
                            onChangeText={(zip_code) => props.setBasicInformationData({
                                ...props.BasicInformationData,
                                zip_code: zip_code
                            })}
                        ...
                        />
                        <Input
                            onChangeText={(phone) => props.setBasicInformationData({
                                ...props.BasicInformationData,
                                phone: phone
                            })}
                        ...
                        />
                        <Input
                            onChangeText={(website) => props.setBasicInformationData({
                                ...props.BasicInformationData,
                                website: website
                            })}
                        ...
                        />
                        <Input
                            onChangeText={(offerings_web_address) => props.setBasicInformationData({
                                ...props.BasicInformationData,
                    ...
                    <View style={styles.servicevwe}>
                        ...
                        <Text style={styles.atlocatetxt}>Do you service you customers at their locations? </Text>
                        <View style={styles.frsttouchvwe}>
                            <TouchableOpacity
                                onPress={() => props.setBasicInformationData({
                                    ...props.BasicInformationData,
                                    service_area: 1
                                })}
                            >

                                {props.BasicInformationData.service_area === 0 || props.BasicInformationData.service_area === null ?
                                    <Image
                            ...
                            <TouchableOpacity style={styles.Touchableopacityallvwe}
                                onPress={() => props.setBasicInformationData({
                                    ...props.BasicInformationData,
                                    service_area: 0
                                })}
                    ...
                    <View style={[styles.servicevwe]}>
                        <View>
                            ...
                            <Text style={styles.longtyxt}>
                                Please note,certain subjective bussiness details
                                (such as "Good fro Groups") can only
                                be updates by the AbbyPages community.
                            </Text>
                        </View>
                        <View style={{ borderBottomWidth: 0.5, borderBottomColor: LINE_COMMON_COLOR_CODE, paddingBottom: 15 }}>
                            ...
                            <View style={styles.beervew}>
                                ...
                                >
                                    {props.BasicInformationData.alcohol === 0 || props.BasicInformationData.alcohol === 2 || props.BasicInformationData.alcohol === null ?
                                        <Image
                                            style={styles.alluncheck}
                                            source={
                                                require('../../../../Assets/unchecked_circled_v1.png')
                            ...
                            <View style={{
                                ...
                                >
                                    {props.BasicInformationData.alcohol === 1 || props.BasicInformationData.alcohol === 0
                            ...
                            <View style={styles.beervew}>
                                ...
                                >
                                    {props.BasicInformationData.alcohol === 1 || props.BasicInformationData.alcohol === 2 ?
                                        <Image
                                            style={styles.alluncheck}
                                            source={
                                                require('../../../../Assets/unchecked_circled_v1.png')
                        ...
                        <View style={{ borderBottomWidth: 0.5, paddingTop: 10, borderBottomColor: LINE_COMMON_COLOR_CODE, paddingBottom: 15 }}>
                        ...
                        <Text style={[styles.alcolholvewtxt, { paddingTop: 10 }]}>Accept Credit Cards</Text>
                        <View style={styles.beervew}>
                            <View style={styles.frsttouchvwe}>
                                <TouchableOpacity style={styles.Touchableopacityallvwe}
                        ...
                        <Text style={[styles.alcolholvewtxt, { paddingTop: 10 }]}>Takes Reservations</Text>
                        <View style={styles.beervew}>
                            <View style={styles.frsttouchvwe}>
                                <TouchableOpacity style={styles.Touchableopacityallvwe}
                                    // onPress={() => props.AcceptCreditCardsYesFun()}
                                ...
                                >
                                    {props.BasicInformationData.takes_reservations === 0 || props.BasicInformationData.takes_reservations === null ?
                                        <Image
                                            style={styles.alluncheck}
                                            source={
                                                require('../../../../Assets/unchecked_circled_v1.png')
                        ...
                        <Text style={[styles.alcolholvewtxt, { paddingTop: 10 }]}>Caters</Text>
                        <View style={styles.beervew}>
                            <View style={styles.frsttouchvwe}>
                                <TouchableOpacity style={styles.Touchableopacityallvwe}
                                    // onPress={() => props.AcceptCreditCardsYesFun()}
                        ...
                        <Text style={[styles.alcolholvewtxt, { paddingTop: 10 }]}>WI-FI</Text>
                        <View style={styles.beervew}>
                            <View style={styles.frsttouchvwe}>
                                <TouchableOpacity style={styles.Touchableopacityallvwe}
                                    // onPress={() => props.AcceptCreditCardsYesFun()}
                        ...
                        <Text style={[styles.alcolholvewtxt, { paddingTop: 10 }]}>Offers Military Discount</Text>
                        <View style={styles.beervew}>
                            <View style={styles.frsttouchvwe}>
                                <TouchableOpacity style={styles.Touchableopacityallvwe}
                                    // onPress={() => props.AcceptCreditCardsYesFun()}
                        ...
                        <Text style={[styles.alcolholvewtxt, { paddingTop: 10 }]}>Good For Happy Hour</Text>
                        <View style={styles.beervew}>
                            <View style={styles.frsttouchvwe}>
                                <TouchableOpacity style={styles.Touchableopacityallvwe}
                                    // onPress={() => props.AcceptCreditCardsYesFun()}
                        ...
                        <Text style={[styles.alcolholvewtxt, { paddingTop: 10 }]}>Wheelchair Accessible</Text>
                        <View style={styles.beervew}>
                            <View style={styles.frsttouchvwe}>
                                <TouchableOpacity style={styles.Touchableopacityallvwe}
                                    // onPress={() => props.AcceptCreditCardsYesFun()}
                        ...
                        <Text style={[styles.alcolholvewtxt, { paddingTop: 10 }]}>Dogs Allowed</Text>
                        <View style={styles.beervew}>
                            <View style={styles.frsttouchvwe}>
                                <TouchableOpacity style={styles.Touchableopacityallvwe}
                                    // onPress={() => props.AcceptCreditCardsYesFun()}
                        ...
                        <Text style={[styles.alcolholvewtxt, { paddingTop: 10 }]}>Accept Cryptocurrency</Text>
                        <View style={styles.beervew}>
                            <View style={styles.frsttouchvwe}>
                                <TouchableOpacity style={styles.Touchableopacityallvwe}
                                    // onPress={() => props.AcceptCreditCardsYesFun()}
                        ...
                        <Text style={[styles.alcolholvewtxt, { paddingTop: 10 }]}>Outdoor Seating</Text>
                        <View style={styles.beervew}>
                            <View style={styles.frsttouchvwe}>
                                <TouchableOpacity style={styles.Touchableopacityallvwe}
                                    // onPress={() => props.AcceptCreditCardsYesFun()}
                        ...
                        <Text style={[styles.alcolholvewtxt, { paddingTop: 10 }]}>Geneder Neutural Restrooms</Text>
                        <View style={styles.beervew}>
                            <View style={styles.frsttouchvwe}>
                                <TouchableOpacity style={styles.Touchableopacityallvwe}
                                    // onPress={() => props.AcceptCreditCardsYesFun()}
                        ...
                        <Text style={[styles.alcolholvewtxt, { paddingTop: 10 }]}>Bike Parking</Text>
                        <View style={styles.beervew}>
                            <View style={styles.frsttouchvwe}>
                                <TouchableOpacity style={styles.Touchableopacityallvwe}
                                    // onPress={() => props.AcceptCreditCardsYesFun()}
                        ...
                        <Text style={[styles.alcolholvewtxt, { paddingTop: 10 }]}>Offers Takeout</Text>
                        <View style={styles.beervew}>
                            <View style={styles.frsttouchvwe}>
                                <TouchableOpacity style={styles.Touchableopacityallvwe}
                                    // onPress={() => props.AcceptCreditCardsYesFun()}
                        ...
                        <Text style={[styles.alcolholvewtxt, { paddingTop: 10 }]}>Open To Call</Text>
                        <View style={styles.beervew}>
                            <View style={styles.frsttouchvwe}>
                                <TouchableOpacity style={styles.Touchableopacityallvwe}
                                    // onPress={() => props.AcceptCreditCardsYesFun()}
                        ...
                        <Text style={[styles.alcolholvewtxt, { paddingTop: 10 }]}>Waiter Service</Text>
                        <View style={styles.beervew}>
                            <View style={styles.frsttouchvwe}>
                                <TouchableOpacity style={styles.Touchableopacityallvwe}
                                    // onPress={() => props.AcceptCreditCardsYesFun()}
                        ...
                        <Text style={[styles.alcolholvewtxt, { paddingTop: 10 }]}>Sit-Down Dining</Text>
                        <View style={styles.beervew}>
                            <View style={styles.frsttouchvwe}>
                                <TouchableOpacity style={styles.Touchableopacityallvwe}
                                    // onPress={() => props.AcceptCreditCardsYesFun()}
                        ...
                        <Text style={[styles.alcolholvewtxt, { paddingTop: 10 }]}>Vegan Opations</Text>
                        <View style={styles.beervew}>
                            <View style={styles.frsttouchvwe}>
                                <TouchableOpacity style={styles.Touchableopacityallvwe}
                                    // onPress={() => props.AcceptCreditCardsYesFun()}
                        ...
                        <Text style={[styles.alcolholvewtxt, { paddingTop: 10 }]}>Staff Wears Gloves</Text>
                        <View style={styles.beervew}>
                            <View style={styles.frsttouchvwe}>
                                <TouchableOpacity style={styles.Touchableopacityallvwe}
                                    // onPress={() => props.AcceptCreditCardsYesFun()}
                        ...
                        <Text style={[styles.alcolholvewtxt, { paddingTop: 10 }]}>Lacation Room</Text>
                        <View style={styles.beervew}>
                            <View style={styles.frsttouchvwe}>
                                <TouchableOpacity style={styles.Touchableopacityallvwe}
                                    // onPress={() => props.AcceptCreditCardsYesFun()}
                        ...
                        <Text style={[styles.alcolholvewtxt, { paddingTop: 10 }]}>Happy Hours Specials</Text>
                        <View style={styles.beervew}>
                            <View style={styles.frsttouchvwe}>
                                <TouchableOpacity style={styles.Touchableopacityallvwe}
                                    // onPress={() => props.AcceptCreditCardsYesFun()}
                        ...
                        <Text style={[styles.alcolholvewtxt, { paddingTop: 10 }]}>Masks Required</Text>
                        <View style={styles.beervew}>
                            <View style={styles.frsttouchvwe}>
                                <TouchableOpacity style={styles.Touchableopacityallvwe}
                                    // onPress={() => props.AcceptCreditCardsYesFun()}
                        ...
                        <Text style={[styles.alcolholvewtxt, { paddingTop: 10 }]}>Cantactless Payment</Text>
                        <View style={styles.beervew}>
                            <View style={styles.frsttouchvwe}>
                                <TouchableOpacity style={styles.Touchableopacityallvwe}
                                    // onPress={() => props.AcceptCreditCardsYesFun()}
                        ...
                        <Text style={[styles.alcolholvewtxt, { paddingTop: 10 }]}>High Chairs</Text>
                        <View style={styles.beervew}>
                            <View style={styles.frsttouchvwe}>
                                <TouchableOpacity style={styles.Touchableopacityallvwe}
                                    // onPress={() => props.AcceptCreditCardsYesFun()}
                        ...
                        <Text style={[styles.alcolholvewtxt, { paddingTop: 10 }]}>Changing Tables</Text>
                        <View style={styles.beervew}>
                            <View style={styles.frsttouchvwe}>
                                <TouchableOpacity style={styles.Touchableopacityallvwe}
                                    // onPress={() => props.AcceptCreditCardsYesFun()}
                        ...
                        <Text style={[styles.alcolholvewtxt, { paddingTop: 10 }]}>Black-Owned</Text>
                        <View style={styles.beervew}>
                            <View style={styles.frsttouchvwe}>
                                <TouchableOpacity style={styles.Touchableopacityallvwe}
                                    // onPress={() => props.AcceptCreditCardsYesFun()}
