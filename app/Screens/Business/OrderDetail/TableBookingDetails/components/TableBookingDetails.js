          ...
          <View style={CommonStyles.container}>
            <View style={styles.body}>
              <Text style={styles.text}>
                Table Booking Id:{" "}
                {props.orderData ? props.orderData.order_id : null}
              </Text>
                  ...
                  <View style={[styles.row, { paddingVertical: 5 }]}>
                    <View style={[styles.row]}>
                      ...
                      <Text style={styles.text}>
                        ...
                        {props.orderData
                          ? props.orderData.booking_details
                            ? props.orderData.booking_details.booking_date
                            : null
                          : null}
                      </Text>
                    </View>
                    <View style={styles.row}>
                      ...
                      <Text style={[styles.text, { color: YELLOW_COLOR_CODE }]}>
                        {props.orderData
                          ? props.orderData.booking_details
                            ? props.orderData.booking_details.booking_time
                            : null
                          : null}
                      </Text>
                      <Text
                        style={[
                          styles.text,
                          { color: YELLOW_COLOR_CODE, paddingLeft: 5 },
                        ]}
                      >
                        {props.orderData
              ...
              {props.orderData ? (
                props.orderData.booking_details ? (
                  <Text style={[styles.text]}>
                    Phone No:{" "}
                    {props.orderData
                      ? props.orderData.booking_details.phone
                      : null}
                  </Text>
                ) : null
              ) : null}
              {props.orderData ? (
                props.orderData.booking_details ? (
                  <Text style={[styles.text]}>
                    People:{" "}
                    {props.orderData
                      ? props.orderData.booking_details.people
                      : null}
                  </Text>
                ) : null
              ) : null}
