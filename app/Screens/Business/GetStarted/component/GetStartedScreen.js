                ...
                <ScrollView keyboardShouldPersistTaps={"always"}>
                    <View style={styles.startxt}>
                        ...
                        <Text style={styles.addmaintxt}>
                            add your bussiness's contact  information to start
                            settings up you account. we're adding  "ITI" in oriandi,
                            Fl ew877, USA to AbbyPages
                            </Text>
                    </View>
                    <View style={{
                        ...
                        <View
                                            ...
                                            return (
                                                item.check === true ?
                                                    <View style={{ padding: 3 }}>
                                                        <View style={{ flexDirection: 'row', margin: 2, justifyContent: 'center', borderWidth: 1, borderRadius: 5, borderColor: '#d8d8d8' }}>
                                                            <View style={{ padding: 5 }}>
                                                                <Text>{item.category_name}</Text>
                                                            </View>
                                                            <TouchableOpacity onPress={() => props.onRemoveService(index)} style={{ borderLeftWidth: 1, padding: 5, borderColor: '#d8d8d8' }}>
                                                                <Text>X</Text>
                                                            </TouchableOpacity>
                                                        </View>
                                                    </View>
                            ...
                            <TouchableOpacity onPress={() => props.onPressBusinessCategories()} style={{ paddingRight: 10 }}>
                    ...
                    <Input
                        onChangeText={(business_name) => props.setBusinessRegistartionData({
                    ...
                    />
                    <Input
                        onChangeText={(business_phone) => props.setBusinessRegistartionData({
                            ...props.businessRegistartionData,
                    ...
                    />
                    <Input
                        onChangeText={(website) => props.setBusinessRegistartionData({
                            ...props.businessRegistartionData,
                            website: website
                        })}
                    ...
                    <GooglePlacesAutocomplete
                        ...
                        onChangeText={
                            (address) => props.setBusinessRegistartionData({
                                ...props.businessRegistartionData,
                                address: address
                            })
                        }
                    ...
                    />
                    <Input
                        onChangeText={(zip_code) => props.setBusinessRegistartionData({
                            ...props.businessRegistartionData,
                            zip_code: zip_code
                        })}
                    ...
                    <View style={styles.lstbtnvwe}>
                        <Text style={styles.continuetxt}>By continuing, you agree to AbbyPages
                            <Text style={styles.bussnesstxt}> Business Terms </Text>and acknowledge our
                            <Text style={styles.pptxt}> privacy policy. </Text>
                            we may email you about AbbyPages products,
