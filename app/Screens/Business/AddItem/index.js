...
const AddItem = ({ route, navigation }) => {
  ...
  const CategoryId = route.params.itemData
    ? route.params.itemData.business_item_category_id
    : route.params.CategoryId;
  const HedarType = route.params ? route.params.type : null;
  const imgUrl = route.params ? route.params.imgUrl : null;
  const itemNames = route.params.itemData
    ? route.params.itemData.item_name
    : null;
  const itemDescriptions = route.params.itemData
    ? route.params.itemData.description
    : null;
  const itemPrices = route.params.itemData ? route.params.itemData.price : null;
  const itemDiscounts = route.params.itemData
    ? route.params.itemData.item_discount
    : null;
  const itemTypes = route.params.itemData
    ? route.params.itemData.item_type
    : null;
  const itemImg = route.params.itemData
    ? route.params.itemData.item_image
    : null;
