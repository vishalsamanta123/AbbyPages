    ...
    return (
        <KeyboardAvoidingView style={[CommonStyles.container]}>
            ...
            <View style={[CommonStyles.body, { backgroundColor: WHITE_COLOR_CODE }]}>
                <Image style={styles.TimeLineImge} source={require('../../../../Assets/Untitled-2.png')} />
                <ScrollView keyboardShouldPersistTaps="always">
                    <View style={styles.WriteTextView}>
                        <Text style={styles.WriteText}>Write your keyword text</Text>
                        <Text style={styles.ShareText}>Share what's special about your business</Text>
                    </View>
                    <View style={props.textOptn ? styles.OptionContain : styles.selectOptionContain}>
