            ...
            <View style={CommonStyles.body}>
                <ScrollView>
                    <View style={styles.ImageContainer}>
                        ...
                        >
                            <View style={{ padding: 20 }}>
                                ...
                                <Text style={styles.ItinfoTextStyle}>{props.profileData.business_name}</Text>
                                <Text style={styles.AddressText}>{props.profileData.address_first ? props.profileData.address_first : props.profileData.address}</Text>
                                ...
                                <TouchableOpacity onPress={() => props.EditInformation()}>
                                    <Text style={[styles.YellowText, { paddingTop: 10 }]}>Edit Information</Text>
                                </TouchableOpacity>
                            </View>
                        </ImageBackground>
                    </View>
                    ...
                    <View style={styles.BookMarkContainer}>
                        ...
                        <Text style={styles.CategoriesDcptnText}>
                            Enter the locations you will go to
                            for a job so you gesturethe right leads
                        </Text>
                    </View>
                    <View style={styles.BookMarkContainer}>
                        <View style={styles.ViewContainer}>
                        ...
                        <Text style={styles.CategoriesDcptnText}>
                            Select your specific services to help you attract the
                            right customers
                        </Text>
                    </View>
                    <View>
                        ...
                        <View style={styles.ActivityView}>
                            <View style={[styles.ActivityOptn, props.ActiveActivity == '1' ? { backgroundColor: YELLOW_COLOR_CODE } : null]}>
                                <TouchableOpacity onPress={() => props._handleDayes('30', '1')}>
                                    <Text style={styles.ActivityOptnTxt}>30 days</Text>
                                </TouchableOpacity>
                            </View>
                            <View style={[styles.ActivityOptn, props.ActiveActivity == '2' ? { backgroundColor: YELLOW_COLOR_CODE } : null]}>
                                <TouchableOpacity onPress={() => props._handleDayes('12', '2')}>
                                    <Text style={styles.ActivityOptnTxt}>12 months</Text>
                                </TouchableOpacity>
                            </View>
                            <View style={[styles.ActivityOptn, props.ActiveActivity == '3' ? { backgroundColor: YELLOW_COLOR_CODE } : null]}>
                    ...
                    <View style={styles.MainWelcomeContain}>
                        <View style={styles.pageVisitView}>
                            ...
                            <Text style={styles.pageVisitTxt}>Page Visits: {props.pageVisit}</Text>
                        </View>
                        <View style={styles.pageVisitView}>
                            <Image source={require('../../../../Assets/info_icon_circled.png')} />
                        ...
                        <Text style={[styles.CategoriesDcptnText, { lineHeight: 21, paddingTop: 5 }]}>
                            This is where you'll see how many people are finding
                            you business on AbbyPages. For now, make sure your
                            page is looking great and check back in few days to see your page activity
                        </Text>
                    </View>
                    ...
                    <View style={styles.AboutCOntainer}>
                        ...
                        <Text style={styles.CategoriesDcptnText}>
                            {Moment().subtract(props.ActiveDuration, 'days').format('MMMM D, YYYY')} - {Moment(now).format('MMMM D, YYYY')}
                        </Text>
                        ...
                        <View style={styles.AboutOptnView}>
                            ...
                            <View style={{ padding: 10, paddingTop: 0 }}>
                                <Text style={styles.TextDescptn}>Your business appeared in AbbyPages</Text>
                                <Text style={styles.TextDescptn}>search results <Text style={{ color: BLACK_COLOR_CODE }}>0 results</Text></Text>
                            </View>
                        </View>
                    </View>
                </ScrollView>
