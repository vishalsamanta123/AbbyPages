...
const GoalsView = ({ navigation }) => {
    ...
    const getProfile = async () => {
        ...
        if (data.status === 200) {
            data.data.business_info ? setGoal(data.data.business_info[0].goal) : null
            data.data.business_info ? setTextOptn(data.data.business_info[0].goal == 1 ? true : false) : null
            data.data.business_info ? setCallingOptn(data.data.business_info[0].goal == 3 ? true : false) : null
            data.data.business_info ? setWebsiteClick(data.data.business_info[0].goal == 2 ? true : false) : null
        };
    };
